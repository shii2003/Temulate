                ...
                <div className='flex-1 h-full items-center w-full flex flex-col min-h-0'>
                    ...
                    <div className='mt-2 sm:mt-4 md:mt-7 flex-1 w-full items-center flex flex-col min-h-0 overflow-auto'>
                        <div className='flex justify-center items-start h-full px-4 py-2 gap-3 sm:gap-4 md:gap-10 flex-wrap w-full min-h-0 overflow-auto'>
                            ...
                            <div className="flex flex-col items-start p-6 rounded-lg border  w-56 h-40 border-neutral-700/50 bg-neutral-800/30 backdrop-blur-sm min-w-[280px] max-w-[320px] ">
                                <LoadingSkeleton className="h-12 rounded-full mb-4 w-full" />
                                <LoadingSkeleton className="h-10 w-full rounded-md" />
                            </div>

                            <div className="flex flex-col w-56 h-40 items-center p-6 rounded-lg border border-neutral-700/50 bg-neutral-800/30 backdrop-blur-sm min-w-[280px] max-w-[320px] ">
                                <LoadingSkeleton className="h-12 rounded-full mb-4 w-full" />
                                <LoadingSkeleton className="h-10 w-full rounded-md" />
                            </div>
                        </div>
